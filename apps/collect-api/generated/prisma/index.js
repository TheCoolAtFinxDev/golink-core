...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/collect-api/generated/prisma",
    "collect-api/generated/prisma",
  ]
...
path.join(process.cwd(), "apps/collect-api/generated/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/collect-api/generated/prisma/schema.prisma")
